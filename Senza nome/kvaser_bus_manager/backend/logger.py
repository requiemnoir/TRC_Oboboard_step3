...
class BusLogger:
    def __init__(self, log_dir=None):
        ...
        try:
            self._mf4_chunk_interval_s = float(os.getenv('MF4_CHUNK_INTERVAL_S', '30.0') or 30.0)
        except Exception:
        ...
        try:
            self._mf4_flush_interval_bytes = int(float(os.getenv('MF4_FLUSH_INTERVAL_MB', '10') or 10.0) * 1024 * 1024)
        except Exception:
